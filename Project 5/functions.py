...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        if spatial_feat == True:
            spatial_features = bin_spatial(feature_image, size=spatial_size) #use bin_spatial
            file_features.append(spatial_features)
        if hist_feat == True:
            # Apply color_hist()
            hist_features = color_hist(feature_image, nbins=hist_bins) #use color_hist
...
class Vehicle():
    def __init__(self):
        ...
        self.bestw = None # average width position of the last n fits
        self.recent_hfitted = [] # height of the last n fits of the bounding box
        self.besth = None # average width position of the last n fits